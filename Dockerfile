...
ARG PHP_EXTENSIONS="@composer bcmath curl grpc igbinary msgpack opcache opentelemetry pcntl pdo_mysql pdo_pgsql protobuf shmop sockets uuid uv xdebug zip zstd"
